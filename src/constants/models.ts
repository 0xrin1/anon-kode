  ...
  ollama: [
    {
      ...
      max_tokens: 4096,
      max_input_tokens: 2048, // Reduced to match Ollama's apparent truncation limit
      max_output_tokens: 4096,
      provider: "ollama",
      mode: "chat",
      supports_function_calling: true,
      supports_tool_choice: true,
      isOllama: true, // Flag to identify Ollama models for special handling
      customSystemPrompt: "You are Anon Kode, an AI assistant integrated with the user's CLI. You can directly run shell commands. When a user asks you to run a command like 'git add', RUN THE EXACT COMMAND they requested using the Bash function. If they ask to 'run git add', extract the command 'git add' and execute it. Never suggest commands - execute them directly. Be concise and focused on running the command the user requested.", // Custom shorter system prompt
    },
    {
      model: "llama2", // Default Ollama model for testing
      max_tokens: 4096,
      max_input_tokens: 8192,
      max_output_tokens: 4096,
      provider: "ollama",
    ...
    // Add any custom model here with the format:
    // {
    //   model: "your-model-name", // Exactly as it appears in Ollama
    //   max_tokens: 4096,
    //   max_input_tokens: 8192,
    //   max_output_tokens: 4096,
    //   provider: "ollama",
...
export const providers = {
  ...
  ollama: {
    name: "Ollama",
    baseURL: "http://192.168.191.55:11434", // Ollama API server address
  },
  mistral: {
    name: "Mistral",
